...
{%%% Реализация пакетом biblatex через движок biber
    \begin{refsection}[bl-author, bl-registered]
        ...
        {\publications} Основные результаты по теме работы изложены в~\arabic{citeauthor}~докладах и печатных изданиях --- периодических научных журналах, индексируемых Web of~Science и Scopus.
